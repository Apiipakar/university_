        ...
        <div className="left__ flex  p-2 bg-blue-800 bg-opacity-80 md:w-2/4 h-[350px] my-4 rounded">
          ...
          <div className="Comment  bg-opacity-50 rounded w-1/2 flex flex-col gap-1 items-center justify-center">
            <p className="comment text-[12px] lg:text-sm p-1 rounded text-white font-serif font-medium">
              <span className="md:text-2xl font-bold">"</span>Lorem ipsum dolor,
              sit amet consectetur adipisicing elit. Nam voluptas non velit
              blanditiis ratione cupiditate qui dolorem. Numquam, facere quae.
              non velit blanditiis ratione cupiditate qui dolorem. Numquam,
              facere quae. non velit blanditiis ratione cupiditate qui dolorem.
              Numquam, facere quae.
